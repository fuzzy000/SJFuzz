...
public class DjfuzzFrameworkResumableAdvanced {
    ...
    public static ThreadPool getJvmThreadPool() {
        return jvmThreadPool;
    }

    private static ThreadPool jvmThreadPool = new ThreadPool(EnvironmentSetting.getJvmNum());
    ...
    DjfuzzFrameworkResumableAdvanced(){
    ...
    public static void setActionContainer(Map<String, Action> actionContainer) {
        DjfuzzFrameworkResumableAdvanced.actionContainer = actionContainer;
    }
...
//        DjfuzzFramework.dumpSingleMutateClass(s.getTarget(), directory);
    ...
    public static void main(String[] args) throws Exception {
        DjfuzzFrameworkResumableAdvanced fwk = new DjfuzzFrameworkResumableAdvanced();
